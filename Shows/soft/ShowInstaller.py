...
with open(str(QFileDialog.getOpenFileName(None, "Select Show File", filter="*.lumiere", directory=r"C:\Users\d1520\Desktop\Lumiere\LumiereTechSoft\Shows\shows")[0])) as f:
